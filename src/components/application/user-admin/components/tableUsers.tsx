...
import {
  ...
  HeadCell,
  KeyedObject,
} from "@/components/ui-components/tables/tbl-enhanced/types";
import EnhancedTableHead from "@/components/ui-components/tables/tbl-enhanced/components/EnhancedTableHead";
...
function TableUsers({ headCells, rows = [] }: EnhancedTableProps) {
