  ...
  return (
    ...
    >
      ...
      <RadioGroup
        ...
        onChange={(e) =>
          onChangeContainer(e.target.value === ContainerType.CONTAINER)
        }
        name="row-radio-buttons-group"
      >
        <FormControlLabel
          control={
            <Radio value={ContainerType.FLUID} sx={{ display: "none" }} />
          }
          label={
            <Avatar
              size="md"
        ...
        <FormControlLabel
          control={
            <Radio value={ContainerType.CONTAINER} sx={{ display: "none" }} />
          }
          label={
            <Avatar
              size="md"
